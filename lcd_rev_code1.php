...
border-top-left-radius: 11px;
	    ...
	    margin: 20px; /* Margin around the container */
   	    background-color: #ffffff;
            ...
            max-width: 1430px; /* Max width to maintain layout */
            height: 590px;
            border-radius: 12px;
            border: 2px solid black;
...
*/
        ...
        .product-info {
            ...
            max-width: 600px; /* Adjust the width for responsiveness */
            margin: 5px 20px 20px 20px auto; /* Center the container horizontally */
            flex-direction: row;
            border:2px solid black;
        }
