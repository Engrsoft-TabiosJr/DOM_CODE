...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $query = "UPDATE details_product SET part_no = ?, model = ?, line = ?, del_date = ?, balance = ?, man_power = ?, ct_as_of = ?, exp_date = ?,prod_hrs = ?, plan_1 = ?, plan_2 = ?, plan_3 = ?, plan_4 = ?, plan_5 = ?, plan_6 = ?, plan_7 = ?, plan_8 = ?, plan_9 = ?, plan_10 = ?, plan_11 = ?, plan_12 = ?, plan_13 = ?, plan_14 = ?, plan_15 = ?, plan_16 = ?, plan_17 = ? WHERE id = ?";
